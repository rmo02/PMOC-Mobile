import { Box, Center, CheckIcon, HStack, Heading, Icon, Pressable, Select, Text, VStack } from "native-base";
...
export function EditDisjuntorForm ({ onSubmit }: any) {
  const [dataDisjuntor, setDataDisjuntor] = useState([]);
