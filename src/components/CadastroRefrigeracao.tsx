...
export function CadastroRefrigeracao() {
  ...
  return (
    <VStack px={5} mt={5}>
      ...
      <VStack bg="white" mt={2} borderRadius={10} py={2} px={5}>
        <TouchableOpacity onPress={() =>  navigation.navigate('criareditarAr')}>
        ...
        <VStack mt={2}>
          <TouchableOpacity onPress={() =>  navigation.navigate('criareditarExaustor')}>
            <HStack alignItems="center" h={10}>
              <Box
                bg="blue.600"
                borderRadius={50}
