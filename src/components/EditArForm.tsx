...
export function EditArForm({ onSubmit }: any) {
  const [dataArcond, setDataArcond] = useState("");
        ...
        <VStack>
          ...
          <VStack mt={5}>
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <Input
                  errorMessage={errors.potencia?.message}
                  onChangeText={onChange}
                  value={value}
          ...
          <VStack mt={5}>
            ...
            <Controller
              control={control}
              name="tensao"
              rules={{ required: "Informe a tensão" }}
              render={({ field: { onChange, value } }) => (
                <Input
                  errorMessage={errors.tensao?.message}
                  onChangeText={onChange}
                  value={value}
                  keyboardType="decimal-pad"
                  placeholder="240"
